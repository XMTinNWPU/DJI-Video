...
public class DJIVideoStreamDecoder implements NativeHelper.NativeDataListener {
    ...
    public interface IYuvDataListener2 {
        /**
         * Callback method for processing the yuv frame data from hardware decoder.
         * @param yuvFrame
         * @param width
         * @param height
         */
        void onYuvDataReceived2(byte[] yuvFrame, int width, int height);
    }
    ...
    public void setYuvDataListener2(IYuvDataListener2 yuvDataListener2) {
        this.yuvDataListener2 = yuvDataListener2;
    }

    private IYuvDataListener2 yuvDataListener2;
    ...
    private void decodeFrame() throws Exception {
        ...
        //Logger.log("decodeFrame: index=" + inIndex);
        ...
        if (inIndex >= 0) {
            ...
            if (surface != null && yuvDataListener2 != null) {
                    ...
                    callbackHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            yuvDataListener2.onYuvDataReceived2(bytes, width, height);
                        }
                    });
                    /*callbackHandler.post(new Runnable() {
                        @Override
                ...
                if (bufferChangedQueue.size() >= 10) {
                    ...
                    if (curTime - headTime < 1000) {
                        ...
                        //Logger.log("Reset decoder. Get INFO_OUTPUT_BUFFERS_CHANGED more than 10 times within a second.");
